...
public class L04_GLEventListener4 implements GLEventListener {

  private static final boolean DISPLAY_SHADERS = false;
  private Camera camera;
  private SGNode twoBranchRoot;
  private TransformNode translateX, rotateAll, rotateUpper, rotateUUpper, rotateTail, rotateHead;
  ...
  public L04_GLEventListener4(Camera camera) {
    this.camera = camera;
  ...
  public void initialise(GL3 gl) {
    ...
    TransformNode makeTailBranch
            = new TransformNode("scale(1.4f,3.1f,1.4f);translate(0,0.5,0)", m4);
    ModelNode cube3Node = new ModelNode("Sphere(3)", cube);
    //
    TransformNode translateToHead
            = new TransformNode("translate(0,4,0)", Mat4Transform.translate(0.2f,3.7f,0));
    rotateHead
            = new TransformNode("rotateAroundZ("+rotateTailAngle+")",
            Mat4Transform.rotateAroundZ(rotateTailAngle));
    NameNode headBranch = new NameNode("tail branch");
    m4 = Mat4Transform.scale(1.5f,0.5f,1f);
    m4 = Mat4.multiply(m4, Mat4Transform.translate(0f,0.5f,0));
    TransformNode makeHeadBranch
            = new TransformNode("scale(1.4f,3.1f,1.4f);translate(0,0.5,0)", m4);
    ModelNode cube4Node = new ModelNode("Sphere(3)", cube);
    //
  ...
  public void render(GL3 gl) {
    ...
    light.render(gl);
    lampLight.setPosition(new Vec3(-4f, 7.5f, 0));  // changing light position each frame
    lampLight.render(gl);
